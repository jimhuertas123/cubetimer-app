...
class CubeTypeRepository {
  ...
  /// Initializes the database and creates the CubeType table if it doesn't exist.
  /// This method should be called when the app starts to ensure that the database is ready for use.
