...
import '../../features/cupertino_modal_popup/create_category_sheet.dart';
      ...
      child: Scaffold(
          ...
          appBar: AppBarHome(
            ...
            subtittle: categoryState.when(
              loading: () => 'Loading...',
              data: (categories) => actualCategory.name.isEmpty ? categories[0].name.toLowerCase() : actualCategory.name.toLowerCase(),
            ...
            scaffoldKey: scaffoldKeyIos,
            onPressedDrawer: () => scaffoldKeyIos.currentState?.openDrawer(),
